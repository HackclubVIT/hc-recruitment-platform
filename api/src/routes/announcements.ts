      ...
      if (candidate.email) {
        sendEmail({
          ...
          html: `
            ...
            <p>You can also log in to your <a href="http://localhost:3000/recruitie/dashboard" style="color: #d07d22; font-weight: bold;">Recruitment Portal Dashboard</a> to view this task and your application status.</p>
            <br/>
