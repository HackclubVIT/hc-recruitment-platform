...
function FormDetailsPageContent() {
  const searchParams = useSearchParams();
  const id = searchParams.get("id") || searchParams.get("formId");
...
export default function FormDetailsPage() {
  return (
    <Suspense fallback={<div className="p-8 text-center text-[#bfa8a2] font-mono">LOADING FORM...</div>}>
