...
function RecruiterCandidateProfileContent() {
...
export default function RecruiterCandidateProfile() {
  return (
    <Suspense fallback={<div className="p-8 text-center text-[#bfa8a2] font-mono">LOADING PROFILE...</div>}>
      <RecruiterCandidateProfileContent />
    </Suspense>
  );
}
